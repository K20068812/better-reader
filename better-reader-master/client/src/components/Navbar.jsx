...
const Navbar = (props) => {
  ...
  return (
    <div className="z-50 w-screen px-5 py-6 bg-gray-100 fixed top-0 left-0 right-0 shadow">
      <div className="mx-auto container flex items-center justify-between z-50">
        <Link to="/">
          ...
          {props.isLoggedIn ? (
            <>
              <Link to="/book-report">
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-8 h-8 cursor-pointer hover:animate-pulse "
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <Link to={`/profile/${props.session?.personal?.id}`}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="w-8 h-8 cursor-pointer text-red-500 hover:animate-pulse "
                onClick={logout}
              >
                <path
                  strokeLinecap="round"
            ...
            <Link to="/login">
              ...
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="w-8 h-8 cursor-pointer text-green-500 hover:animate-pulse "
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
